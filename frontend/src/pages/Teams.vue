<template>
  <div
    class="mx-auto w-full max-w-md bg-surface-white dark:bg-surface-gray-2 px-4 py-6 sm:py-8 sm:mt-6 rounded-2xl p-4 sm:p-6 sm:shadow-2xl flex flex-col gap-4"
  >
